module DI
    module SketchupHelper
        ...
        #TIG sample code
        def self.group_comp_check e1, e2
        ...
        def self.group_bounds_check group1, group2
            basegroup = group1
            cutgroup = group2
            base_trans = basegroup.transformation
            cut_trans = cutgroup.transformation
        
            return cutgroup.entities.intersect_with false, cut_trans, basegroup, base_trans , true, basegroup 
        end
